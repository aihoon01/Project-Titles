...
function updateResults(){
  ...
  const averageSalaryByRole = formatNuber.format(getAverageSalaryByRole(role));
  const averageSalaryByCompany = formatNuber.format(getAverageSalaryByCompany(company));
  const salary = formatNuber.format(getSalaryAtCompany(role, company));
  const industryAverageSalary = formatNuber.format(getIndustryAverageSalary());
